...
const DEFINITIONS := {
	"signal_hold": {
		"name": "SIGNAL HOLD",
		"description": "Survive the carrier swarm long enough to expose its route.",
		"required": true,
		"prerequisites": [],
	...
	"overseer_lock": {
		...
		"first_clear_discoveries": ["nova"],
		"completion_copy": "The Overseer's armory yields Nova Burst. The lock remains available for build trials.",
		"mission": {
			"id": "overseer_lock",
			"name": "OVERSEER LOCK",
			"rhythm": "BOSS",
